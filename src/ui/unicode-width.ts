...
// 而 ※ … → “” 这些符号全在里面。
//
// 统计：宽 122 段 · 零宽 357 段 · 不定宽 179 段

/** 东亚宽度 W/F：一定是 2 列。 */
export const WIDE: ReadonlyArray<readonly [number, number]> = [
...
/** 不占位（组合符号、零宽字符）。 */
export const ZERO: ReadonlyArray<readonly [number, number]> = [
  ...
  [0x1dc0, 0x1dff], [0x200b, 0x200b], [0x200d, 0x200d], [0x20d0, 0x20f0],
...
/** 东亚宽度 A（不定宽）：字体说了算，1 列还是 2 列无法预测。 */
export const AMBIGUOUS: ReadonlyArray<readonly [number, number]> = [
